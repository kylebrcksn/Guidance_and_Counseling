          ...
          <div class="modal-header header-color-modal bg-color-1">
              ...
              <div class="form-group-inner">
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                    <input type="text" id="view-personal-sub" class="form-control"  disabled/>
                  </div>
                </div>
              </div>
            ...
            <div class="form-group-inner">
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                    <input type="text" id="view-personal-time" class="form-control"  disabled/>
                  </div>
                </div>
            </div>
              ...
              <div class="form-group-inner data-custon-pick" id="data_2">
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                    <input type="text" id="view-personal-date" class="form-control" disabled/>
                  </div>
                </div>
              </div>
            ...
            <div class="form-group-inner">
              ...
              <div class="form-group-inner data-custon-pick" id="data_2">
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                    <input type="text" id="personal-date" class="form-control" disabled/>
                  </div>
                </div>
              </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                        <div class="input-group">
                            <input type="text" class="form-control" id="student_name" placeholder="Search Student">
            ...
            <div class="form-group-inner">
              ...
              <div class="form-group-inner" id="meeting">
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                    <input type="text" id="meetinglink" class="form-control" placeholder="Meeting Link  " />
                    <a href="https://teams.microsoft.com/_#/scheduling-form/?opener=1&navCtx=new-meeting-button&calendarType=User&webinarType=None" target="_blank" class="btn btn-primary btn-sm" style="float: right;">Link</a>
                  </div>
                </div>
              </div>
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            $.ajax({
                ...
                $(document).on("click", "#search-user", ()=>{
                   ...
                   $("#modal-title").text('Results for "'+ $("#student_name").val()+'"');
                });
